...
public class SecondaryController implements Initializable {
    ...
    void carAdd(ActionEvent event) {
        if (currentCustomer == null){
            Popups.showErrorDialog("No cutomer selected!");
        }
...
//        listviewComponents.getItems().add()
    ...
    void chooseComponent(ActionEvent event) {
        ...
        if (selectedComponent == null) {
            Popups.showErrorDialog("Select a component to add to selected Car");
            return;
        }
    ...
    void deleteComponent(ActionEvent event) {
        Car selectedCar = tableViewCar.getSelectionModel().getSelectedItem();
        Component selectedComponent = listviewSelectedComponents.getSelectionModel().getSelectedItem();

        if (selectedComponent == null) {
            Popups.showErrorDialog("Select a component to remove from selected Car");
            return;
        }
